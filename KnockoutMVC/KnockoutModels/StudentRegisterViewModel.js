...
function StudentList() {
    ...
    self.editStudent = function (student) {
        self.Id = ko.observable(student.Id());
        ...
        self.Age = ko.observable(student.Age());
        self.Description = ko.observable(student.Description());
        self.Gender = ko.observable(student.Gender());
    }
}
